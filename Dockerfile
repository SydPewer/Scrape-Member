...
#RUN git clone -b main https://github.com/SydPewer/Scrape-Member /root/userbot
#RUN mkdir /root/userbot/bin/
#WORKDIR /root/userbot/
#RUN chmod +x /usr/local/bin/*
RUN wget https://raw.githubusercontent.com/SydPewer/Scrape-Member/main/sh1vamrun.py
RUN wget https://raw.githubusercontent.com/SydPewer/Scrape-Member/main/requirements.txt
